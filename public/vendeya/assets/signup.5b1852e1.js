import { _ as __unplugin_components_0 } from "./LogoMozoOficial.df30c763.js";
import { _ as __unplugin_components_1$1 } from "./VControl.8f7a9833.js";
import { _ as _sfc_main$2 } from "./VField.cf44fb41.js";
import { a as __unplugin_components_0$1, _ as _sfc_main$3 } from "./VButton.0d870fba.js";
import { _ as _export_sfc } from "./plugin-vue_export-helper.5a098b48.js";
import { f as openBlock, g as createElementBlock, y as renderSlot, b as defineComponent, ac as toRef, a as computed, L as watch, s as resolveDynamicComponent, q as h, K as toRefs, ad as inject, Z as unref, o as onMounted, p as provide, S as isRef, ae as onBeforeUnmount, r as ref, t as reactive, O as nextTick, af as warn$1, ag as readonly, Q as getCurrentInstance, ah as markRaw, ai as commonjsGlobal, a4 as useRouter, aj as useI18n, e as useHead, x as resolveComponent, X as createBaseVNode, w as createVNode, B as withCtx, z as toDisplayString, Y as normalizeClass, j as axios, E as mergeProps, C as createCommentVNode, F as Fragment, A as renderList, v as createBlock, D as createTextVNode } from "./vendor.73f133b9.js";
import { i as isDark, t as toggleDarkModeHandler, _ as __unplugin_components_1 } from "./IsotipoMozoOficial.9f9a51a9.js";
import { a as useNotyf } from "./index.d5ede680.js";
const _sfc_main$1 = {};
const _hoisted_1$1 = { class: "placeload-wrap is-flex" };
function _sfc_render(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$1, [
    renderSlot(_ctx.$slots, "default")
  ]);
}
var __unplugin_components_4 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render]]);
/**
...
const _hoisted_17 = /* @__PURE__ */ createBaseVNode("p", { class: "help is-muted" }, " Usado en Slack para soporte de Facturador PRO4 ", -1);
const _hoisted_18 = {
  key: 0,
  class: "help is-danger"
};
...
const _hoisted_25 = { class: "column has-text-centered" };
const _hoisted_26 = { class: "column login-column is-7 is-hidden-mobile hero-banner" };
const _hoisted_27 = { class: "hero login-hero is-fullheight is-app-grey" };
const _hoisted_28 = { class: "hero-body" };
const _hoisted_29 = { class: "columns" };
const _hoisted_30 = { class: "column is-10 is-offset-2 has-text-centered" };
const _hoisted_31 = /* @__PURE__ */ createBaseVNode("div", { class: "hero-footer" }, [
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    const { t } = useI18n();
    const initialValues = { department: "14" };
    const schema = create({
      promotional: create$3(),
      name: create$2().required(t("auth.errors.name.required")),
      email: create$2().required(t("auth.errors.email.required")).email(t("auth.errors.email.format")),
      gitlab: create$2().required(t("auth.errors.gitlab.required")).max(20, t("auth.errors.gitlab.length")),
      domain: create$2().required(t("auth.errors.domain.required")),
      department: create$1().required(t("auth.errors.department.required"))
    });
    const handleSignup = async (values) => {
      ...
      const headers = {
        ...
        Authorization: `Bearer ${{}.VITE_FACTURADOR_ACCESS_TOKEN}`
      };
      await axios.post(`${{}.VITE_FACTURADOR_BASE_URL}/api/restaurant/partner/store`, payload, { headers }).then((response) => {
    ...
    useHead({
      title: "Registro de Distribuidor - Vendeya.pe"
    });
    return (_ctx, _cache) => {
      ...
      const _component_VPlaceloadWrap = __unplugin_components_4;
                      ...
                      createVNode(unref(Form), {
                        ...
                        default: withCtx(() => [
                          createBaseVNode("div", _hoisted_15, [
                            ...
                            createVNode(unref(Field), { name: "gitlab" }, {
                              default: withCtx(({ field, errorMessage }) => [
                                createVNode(_component_VField, null, {
                                  default: withCtx(() => [
                                    createVNode(_component_VControl, {
                                      ...
                                      default: withCtx(() => [
                                        createBaseVNode("input", mergeProps(field, {
                                          class: "input",
                                          type: "text",
                                          placeholder: "Usuario de Gitlab.com",
                                          autocomplete: "gitlab"
                                        }), null, 16),
                            ...
                            createVNode(unref(Field), { name: "domain" }, {
                              default: withCtx(({ field, errorMessage }) => [
                                createVNode(_component_VField, null, {
                                  default: withCtx(() => [
                                    createVNode(_component_VControl, {
                                      ...
                                      default: withCtx(() => [
                                        createBaseVNode("input", mergeProps(field, {
                                          class: "input",
                                          type: "text",
                                          placeholder: "Dominio de Facturador PRO4",
                                          autocomplete: "domain"
                                        }), null, 16),
                            ...
                            createVNode(unref(Field), { name: "department" }, {
                              default: withCtx(({ field, errorMessage }) => [
                                createVNode(_component_VField, null, {
                                  default: withCtx(() => [
                                    createVNode(_component_VControl, {
                                      ...
                                      default: withCtx(() => [
                                        createBaseVNode("div", _hoisted_21, [
                                          createBaseVNode("select", mergeProps({ class: "input" }, field, { placeholder: "Departamento" }), [
                                            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(departments), (item) => {
                            ...
                            createVNode(unref(Field), { name: "zone" }, {
                              default: withCtx(({ field, errorMessage }) => [
                                createVNode(_component_VField, null, {
                                  default: withCtx(() => [
                                    createVNode(_component_VControl, {
                                      ...
                                      default: withCtx(() => [
                                        createBaseVNode("textarea", mergeProps(field, {
                                          class: "textarea",
                                          rows: "4",
                                          placeholder: "Zona de trabajo/cobertura"
                                        }), null, 16),
                                        errorMessage ? (openBlock(), createElementBlock("p", _hoisted_24, toDisplayString(errorMessage), 1)) : createCommentVNode("", true)
                                      ]),
                                      _: 2
                                    }, 1032, ["has-error"])
                                  ]),
                            ...
                            createVNode(_component_VField, null, {
                              default: withCtx(() => [
                                createVNode(_component_VControl, { class: "login" }, {
                                  default: withCtx(() => [
                                    isLoading.value ? (openBlock(), createBlock(_component_VPlaceloadWrap, { key: 0 }, {
                                      default: withCtx(() => [
