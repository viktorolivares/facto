...
import { N as NAME_ROUTE_POS, d as NAME_ROUTE_MESAS, a as useNotyf, u as useUserSession, p as provideApi } from "./index.3a773319.js";
import { u as useCompanySession, a as useProductSession, M as MasterService } from "./masterService.252e633b.js";
import { a as _sfc_main$k, _ as _sfc_main$l, p as pageTitle } from "./VIconButton.04ed91bf.js";
...
const SaveCustomer = async (payload) => {
  try {
    ...
    companySession$2.setCustomers(customers);
    return response;
  } catch (err) {
    return null;
  }
...
const establishments = companySession$1.establishments;
const buildAcciones = async () => {
  var _a;
  return {
    formato_pdf: "ticket",
    auto_print: !!((_a = companySession$1.configuration) == null ? void 0 : _a.printer_enabled),
...
const getDocumentPayload = async (items, customer, cpe, payments = []) => {
  ...
  payload["items"] = items.map((item) => {
    ...
    const row = {
      ...
      presentacion: (_a = item.presentation) != null ? _a : null
    };
...
const useBagStore = defineStore("bagStore", () => {
  ...
  function addProduct(item) {
    ...
    const validate_stock_add_item = companySession.configuration.validate_stock_add_item;
