...
import { N as NAME_ROUTE_POS, d as NAME_ROUTE_MESAS, a as useNotyf, u as useUserSession, p as provideApi } from "./index.76a52da4.js";
import { u as useCompanySession, a as useProductSession, M as MasterService } from "./masterService.1117a1ab.js";
import { a as _sfc_main$k, _ as _sfc_main$l, p as pageTitle } from "./VIconButton.e8d7e7a2.js";
...
const useCashSession = defineStore("cashSession", () => {
  ...
  function cleanCash(nameRoute) {
    ...
    notif.success("Caja cerrada exitosamente");
  }
...
const _hoisted_20$5 = /* @__PURE__ */ createTextVNode("4");
...
const _hoisted_20$4 = /* @__PURE__ */ createTextVNode("8");
...
const _hoisted_20$3 = { class: "add-client" };
  ...
  setup(__props, { emit }) {
    ...
    const payment = async () => {
      if (!state.serie.number) {
        return notif.error("Debe seleccionar una serie.");
      }
      if (isCpe.value) {
        if (state.documentSelected == "BOLETA") {
          ...
          if (state.posBag.total > 700 && !codigo_tipo_documento_identidad_permitidos_boletas.includes(state.customer.codigo_tipo_documento_identidad)) {
            return notif.error("No puede superar el monto de 700.0");
          }
        }
        if (state.documentSelected == "FACTURA") {
          ...
          if (!codigo_tipo_documento_identidad_permitidos_facturas.includes(state.customer.codigo_tipo_documento_identidad)) {
            return notif.error("El tipo doc. identidad del cliente no es v\xE1lido");
          }
        }
      }
      state.cashAvailable = await cashOpeningCheck();
      if (!state.cashAvailable) {
        return notif.error("Debe aperturar una caja");
      }
      state.loading = true;
      ...
      if (state.documentSelected == "NOTA") {
        if (!network) {
          ...
          notif.success("Se guard\xF3 el comprobante.");
          state.loading = false;
        } else {
      ...
      switch (state.documentSelected) {
        ...
        case "FACTURA": {
          ...
          if (values.length) {
            ...
            notif.error("No existe clientes disponibles para Factura.");
          }
          break;
        }
        case "NOTA":
...
const _withScopeId = (n) => (pushScopeId("data-v-9133c006"), n = n(), popScopeId(), n);
const _hoisted_1$6 = {
...
const _hoisted_6$3 = { class: "meta-container" };
const _hoisted_7$3 = { class: "meta-content" };
const _hoisted_8$3 = { class: "columns price-name-content is-justify-content-space-between px-3 mt-1" };
const _hoisted_9$3 = { class: "column is-half truncate-content pl-0 py-1 pr-1" };
const _hoisted_10$3 = { class: "item-internalid price-name-description" };
const _hoisted_11$3 = { class: "column is-half truncate-content p-1" };
const _hoisted_12$3 = { class: "mb-2" };
const _hoisted_13$3 = ["title"];
const _hoisted_14$3 = { class: "price-list-summary mb-4" };
const _hoisted_15$3 = { class: "price-list-table-wrapper" };
const _hoisted_16$3 = { class: "table is-fullwidth price-list-table" };
const _hoisted_17$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("thead", null, [
  /* @__PURE__ */ createBaseVNode("tr", null, [
...
const _hoisted_18$3 = { class: "has-text-right has-text-weight-semibold" };
const _hoisted_19$3 = { class: "has-text-right" };
        ...
        createVNode(_component_VModal, {
          ...
          content: withCtx(() => [
            ...
            createBaseVNode("div", _hoisted_15$3, [
              createBaseVNode("table", _hoisted_16$3, [
                _hoisted_17$3,
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(availablePrices), (option) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_18$3, toDisplayString(props.product.currencyTypeSymbol) + " " + toDisplayString(option.price.price.toFixed(2)), 1),
...
var __unplugin_components_5 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-9133c006"]]);
...
const useBagStore = defineStore("bagStore", () => {
  ...
  function addProduct(item) {
    const duplicateIndex = bag.products.findIndex((x) => x.id == item.id);
    if (duplicateIndex >= 0) {
      if (item.presentation) {
        bag.products[duplicateIndex].price = item.price;
        bag.products[duplicateIndex].unitTypeId = item.unitTypeId;
        bag.products[duplicateIndex].presentation = item.presentation;
      }
  ...
  setup(__props) {
    ...
    const syncPosData = async () => {
      try {
        ...
        notif.error("No se pudieron actualizar los productos");
      }
      loadProducts();
      filteredProductsDefault();
    };
