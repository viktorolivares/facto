import { b as defineComponent, f as openBlock, g as createElementBlock, y as renderSlot, Y as normalizeClass, Z as unref, X as createBaseVNode, z as toDisplayString, C as createCommentVNode } from "./vendor.dca42141.js";
function useViaPlaceholderError(event, size) {
  const target = event.target;
  target.src = `https://placehold.co/${size}`;
}
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  props: {
    ...
    placeholder: { type: String, required: false, default: "https://placehold.co/50x50" },
