...
import { a as __unplugin_components_4, _ as _sfc_main$2 } from "./VButton.2bd31a3c.js";
...
import { b as defineComponent, ae as toRef, a as computed, L as watch, s as resolveDynamicComponent, q as h, K as toRefs, af as inject, Z as unref, o as onMounted, p as provide, S as isRef, ag as onBeforeUnmount, r as ref, t as reactive, O as nextTick, ah as warn$1, ai as readonly, Q as getCurrentInstance, aj as markRaw, ak as commonjsGlobal, a4 as useRouter, ac as useI18n, e as useHead, x as resolveComponent, f as openBlock, g as createElementBlock, X as createBaseVNode, w as createVNode, B as withCtx, z as toDisplayString, Y as normalizeClass, j as axios, E as mergeProps, C as createCommentVNode, F as Fragment, A as renderList, v as createBlock, D as createTextVNode } from "./vendor.dca42141.js";
import { c as useNotyf } from "./index.8c6daf4a.js";
  ...
  setup(__props) {
    ...
    const handleSignup = async (values) => {
      ...
      const headers = {
        ...
        Authorization: `Bearer ${"Nl1lgdvZd8gbZqnTdN7GWnZVbd7jUWti2OFTuFK2AJJfiD5UuX"}`
      };
      await axios.post(`${"http://1.facturaloperu-pro7.oo"}/api/restaurant/partner/store`, payload, { headers }).then((response) => {
    ...
    useHead({
      title: "Registro de Distribuidor - Mozo.pe"
    });
    return (_ctx, _cache) => {
