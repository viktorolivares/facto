import { ak as commonjsGlobal, aw as _defineProperty } from "./vendor.dca42141.js";
...
var uncurryThis$q = bind$6 && bind$6.bind(call$e, call$e);
...
var setGlobal$3 = function(key, value) {
  try {
    defineProperty$2(global$y, key, { value, configurable: true, writable: true });
  } catch (error) {
    global$y[key] = value;
  }
  return value;
...
var functionBindContext = function(fn, that) {
  aCallable$4(fn);
  return that === void 0 ? fn : bind$5 ? bind$5(fn, that) : function() {
