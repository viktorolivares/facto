...
import { ak as commonjsGlobal, b as defineComponent, t as reactive, f as openBlock, g as createElementBlock, X as createBaseVNode, F as Fragment, A as renderList, Y as normalizeClass, z as toDisplayString, Z as unref } from "./vendor.dca42141.js";
var uikit = { exports: {} };
...
(function(module, exports) {
  (function(global, factory) {
    ...
    function unwrap(element) {
      toNodes(element).map(parent).filter(function(value, index2, self) {
    ...
    function scrollIntoView(element, ref) {
      ...
      return parents2.reduce(function(fn, scrollElement, i) {
        ...
        var ref2 = offset(parents2[i - 1] || element);
        var elHeight = ref2.height;
        var elTop = ref2.top;
    ...
    function stateAPI(UIkit3) {
      ...
      function registerEvent(component, event, key2) {
        ...
        component._events.push(on(el, name, !delegate2 ? null : isString(delegate2) ? delegate2 : delegate2.call(component), isString(handler) ? component[handler] : handler.bind(component), { passive, capture, self }));
      }
        ...
        },
        {
          ...
          handler: function() {
            ...
            once(this.$el, "hide", on(document, pointerDown, function(ref) {
              var target = ref.target;
              return !within(target, this$1$1.$el) && once(document, pointerUp + " " + pointerCancel + " scroll", function(ref2) {
...
const _hoisted_1 = { "uk-slider": "" };
const _hoisted_2 = { class: "uk-position-relative" };
const _hoisted_3 = { class: "uk-slider-container mx-5" };
const _hoisted_4 = { class: "uk-slider-items" };
