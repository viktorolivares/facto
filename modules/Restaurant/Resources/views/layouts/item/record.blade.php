...
<head>
    ...
    <title>{{ $pageTitle ? ($productName ? $pageTitle.' - '.$productName : $pageTitle) : ($productName ?: 'Restaurante') }}</title>
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="keywords" content="Pedidos, Menu, Restaurante, {{ $pageTitle }}, {{ $productName }}" />
