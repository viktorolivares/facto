    ...
    Route::domain($current_hostname->fqdn)->group(function () {
        Route::middleware(['auth', 'locked.tenant'])->group(function () {
            ...
            Route::prefix('sale-opportunities')->group(function() {
                ...
                Route::get('', 'SaleOpportunityController@index')->name('tenant.sale_opportunities.index')->middleware(['redirect.level','check.email.verified']);
                ...
                Route::get('create/{id?}', 'SaleOpportunityController@create')->name('tenant.sale_opportunities.create')->middleware(['redirect.level','check.email.verified']);
            ...
            Route::prefix('contracts')->group(function () {
                ...
                Route::get('', 'ContractController@index')->name('tenant.contracts.index')->middleware(['redirect.level','check.email.verified']);
                Route::get('/columns', 'ContractController@columns');
                Route::get('/records', 'ContractController@records');
                Route::get('/create/{id?}', 'ContractController@create')->name('tenant.contracts.create')->middleware('redirect.level','check.email.verified');
                ...
                Route::get('/generate-quotation/{quotation}', 'ContractController@generateContract')->middleware(['redirect.level','check.email.verified']);
        ...
        Route::prefix('production-orders')->group(function () {
            ...
            Route::get('', 'ProductionOrderController@index')->name('tenant.production_orders.index')->middleware(['redirect.level','check.email.verified']);
        ...
        */
        Route::prefix('technical-services')->group(function () {
            ...
            Route::get('', 'TechnicalServiceController@index')->name('tenant.technical_services.index')->middleware(['redirect.level','check.email.verified']);
        ...
        Route::prefix('user-commissions')->group(function () {
            ...
            Route::get('', 'UserCommissionController@index')->name('tenant.user_commissions.index')->middleware(['redirect.level','check.email.verified']);
