...
class OrderFormController extends Controller
{
    ...
    public function dispatchCreate($order_form_id)
    {
        ...
        $orderFormFind = OrderForm::find($order_form_id);

        $orderForm = [
            "establishment_id" => $orderFormFind->establishment_id, 
            'items' => [],
            "customer_id" => $orderFormFind->customer_id,
            'transport_mode_type_id' => $orderFormFind->transport_mode_type_id,
            "transfer_reason_type_id" => $orderFormFind->transfer_reason_type_id
        ];

        $configuration = Configuration::query()->first();
        foreach ($orderFormFind->items as $items) {
        ...
        return view('order::order_forms.create', compact('orderForm'));
    }
