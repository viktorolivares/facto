          ...
          <table class="table">
            ...
            <tbody>
              <tr v-for="item in items" :key="item.id">
                ...
                <td class="text-end">
                  <el-button class="me-1 btn-info btn btn-xs btn-shad" type="info" @click="onEdit(item)">
                  ...
                  <el-button class="btn btn-xs btn-shad btn-danger" type="danger" @click="onDelete(item)">
