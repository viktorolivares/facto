                    ...
                    <table class="">
                        <thead>
                            <tr>
                                ...
                                <th class="">Saldo</th>
                                <th class="">Estado</th>
                                <th class="">Descripción de los gastos</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <td class="celda">
                                    @php
                                        ...
                                        foreach ($record->expense_items as $item) {
                                            ...
                                            array_push($description_full, $item_parse->description);
                                        }
                                        $description_full_string = implode(", ", $description_full);

                                    @endphp
                                    {{ $description_full_string }}
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
