            ...
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div
                            class="form-group"
                            :class="{ 'has-danger': errors.warehouse_new_id }"
                        >
                            ...
                            <small
                                ...
                                v-if="errors.warehouse_new_id"
                                v-text="errors.warehouse_new_id[0]"
                            ></small>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div
                            class="form-group"
                            :class="{ 'has-danger': errors.detail }"
                        >
                            <label class="control-label"
    ...
    methods: {
        ...
        async submit() {
            if (this.form.series_enabled) {
                ...
                if (
                    this.form.lots.length !== parseInt(this.form.quantity_move)
                ) {
            ...
            await this.$http
                .post(`/${this.resource}/move`, this.form)
                .then(response => {
