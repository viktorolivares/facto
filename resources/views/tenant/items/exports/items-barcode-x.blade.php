                                            ...
                                            <td colspan="2" style="text-align: center;">
                                                <p>
                                                    @php
                                                        ...
                                                        echo '<img style="width:130px; max-height: 70px;" src="data:image/png;base64,' . base64_encode($generator->getBarcode($record->barcode, $generator::TYPE_CODE_128, 2, 80, $colour)) . '">';
                                                    @endphp
                                                </p>
                                                <p>{{$record->barcode}}</p>
                                            </td>
