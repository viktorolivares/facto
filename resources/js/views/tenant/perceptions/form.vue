                ...
                <form autocomplete="off" @submit.prevent="submit">
                    <div class="form-body">
                        ...
                        <div class="row mt-2" v-if="form.documents.length > 0">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr> 
                                            ...
                                            <th>Moneda</th>
                                            <th class="text-end">T. Percepción</th>
                                            <th class="text-end">T. Comprobante</th>
                                            <th class="text-end">T. A pagar</th>
                                            <th class="text-end">T. Pagado</th>
                                            <th></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                            ...
                            <div class="col-md-12">
                                <p class="text-end" v-if="form.total_perception > 0">Total Percepción : {{ currency_symbol }} {{ form.total_perception }}</p>
                                <template v-if="form.total > 0">
                                    <h3 class="text-end"><b>Total : </b>{{ currency_symbol }} {{ form.total }}</h3>
                                </template>
                            </div>
                        </div>
                    </div>
