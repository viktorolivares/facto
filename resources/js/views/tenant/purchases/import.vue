...
export default {
    ...
    methods: {
        ...
        async setdataForm() {
            ...
            if (
                Invoice["cac:AccountingSupplierParty"] !== undefined &&
                Invoice["cac:AccountingSupplierParty"]["cac:Party"] !== undefined &&
                Invoice["cac:AccountingSupplierParty"]["cac:Party"]["cac:PartyIdentification"] !== undefined &&
                Invoice["cac:AccountingSupplierParty"]["cac:Party"]["cac:PartyIdentification"]["cbc:ID"] !== undefined &&
                Invoice["cac:AccountingSupplierParty"]["cac:Party"]["cac:PartyIdentification"]["cbc:ID"]["_text"] !== undefined
            ) {
