...
//        ]);
        ...
        DB::table('cat_currency_types')->insert([
            ...
            ['id' => 'USD', 'active' => false, 'symbol' => '$',  'description' => 'Dólares Americanos'],
        ]);
        ...
        DB::table('cat_affectation_igv_types')->insert([
            ...
            ['id' => '11', 'active' => false, 'exportation' => false, 'free' => true,  'description' => 'Gravado – Retiro por premio'],
            ['id' => '12', 'active' => false, 'exportation' => false, 'free' => true,  'description' => 'Gravado – Retiro por donación'],
            ['id' => '13', 'active' => false, 'exportation' => false, 'free' => true,  'description' => 'Gravado – Retiro'],
...
//        ]);
        ...
        DB::table('cat_operation_types')->insert([
            ...
            ['id' => '0200', 'active' => false, 'exportation' => true,  'description' => 'Exportación de Bienes'],
