<?php
    ...
    class FunctionsHelper
    {
        ...
        public static function generatePathQueryByPeriod(string $period, $filter = []) 
        {
            $url = '';
            switch ($period) {
                case 'date':
                    $url .= '?period=date&date_start='.$filter['date_start'];
                    break;
                case 'month':
                    $url .= '?period=month&month_start='.$filter['month_start'];
                    break;
                case 'between_dates':
                    $url .= '?period=between_dates&date_start='.$filter['date_start'].'&date_end='.$filter['date_end'];
                    break;
