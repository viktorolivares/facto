...
use Illuminate\Support\Facades\Log;
    ...
    class Configuration extends ModelTenant
    {
        protected $fillable = [
            ...
            'qr_api_enable',
            'qr_api_instance',
            'qr_api_instance_adopted',
            'qr_api_connected_phone',
            'qr_api_profile_name',
            'qr_api_instance_token',
        ...
        protected $casts = [
            ...
            'evolution_instance_adopted' => 'boolean',
            'evolution_use_qr_api_instance' => 'boolean',
            'qr_api_instance_adopted' => 'boolean',
        ...
        {
            return self::select(['from_guest_register', 'was_verified_guest_user', 'date_of_due_test_days'])->firstOrFail();
        }
        ...
        public function isTestDaysExpired()
        {
            if (!$this->date_of_due_test_days) {
                return false;
            }

            return Carbon::parse($this->date_of_due_test_days)->startOfDay()
